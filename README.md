...
| `npm run check:links` | Controleert alle interne links in de productiebuild en faalt bij een dode link |
| `npm run ci` | Draait typecheck, productiebuild en linkcontrole achter elkaar |
