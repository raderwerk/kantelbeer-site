...
export const COPY: Record<Locale, Copy> = {
	nl: {
		...
		postcodeHint:
			'Nederland: 1234 AB. België: 2000 (kies België als land). Duitsland: 50667. Er wordt geen locatie van je browser gevraagd.',
		countryLabel: 'Land van de postcode',
		countryAuto: 'Automatisch herkennen',
	...
	en: {
		...
		postcodeLabel: 'Postcode',
		postcodeHint:
			'Netherlands: 1234 AB. Belgium: 2000 (set country to Belgium). Germany: 50667. Your browser is never asked for a location.',
